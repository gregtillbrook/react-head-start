/*
This file is paired with codeSplitMappingsAsync.js - they must the same exports
...
Unlike the codeSplitMappingsAsync all imports on server are standard module imports (the server 
